...
import com.dyc.codegen.utils.Test;
        ...
        if (jEditorPane == null) {
            ...
            obkbut.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (type == Constants.KEY_GEN_ACTVITY) {
                        try {
                            //get the xml short name ,and give the name to Activity
                    ...
                    } else if (type == Constants.KEY_GEN_ADAPTER) {
                        Test.genadapter(path);
                    } else if (type == Constants.KEY_GEN_FRAGMENT) {
            ...
            if (type == Constants.KEY_GEN_ADAPTER) {
