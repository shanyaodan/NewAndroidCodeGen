...
import com.dyc.codegen.Resource;
import com.dyc.codegen.utils.CommUtitl;
import com.dyc.codegen.utils.Utils;
...
//        }
    ...
    public static String genActivity(String layoutFil, String entityname) {
        ...
        try {
            ...
            e.printStackTrace();
            Messages.showErrorDialog((CommUtitl.projPath + CommUtitl.ideaPackage + CommUtitl.activitypackageName).replace("\\", "/"), "error");
        ...
        try {
            ...
            e.printStackTrace();
            Messages.showErrorDialog((CommUtitl.projPath + CommUtitl.ideaPackage + CommUtitl.activitypackageName).replace("\\", "/"), "error2");
    ...
    private static String getXMLClassName(String xmlname) {
        ...
        try {
            ...
            acitivyname = CommUtitl.firstTopCast(subfix)
                    + CommUtitl.firstTopCast(prfix);
        } catch (Exception e) {
            acitivyname = CommUtitl.firstTopCast(xmlname);
        }
        return acitivyname;
    }
}